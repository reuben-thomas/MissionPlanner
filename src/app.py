...
path_dict = {"0f":"0.0", "1f":"1.0", "1r":"1.1", "2f":"2.0", "2r":"2.1", "3f":"3.0", 
            "3r":"3.1", "4f":"4.0", "5f":"5.0", "5r":"5.1", "6f":"6.0", "6r":"6.1", "7f":"7.0"}
    ...
    for path_id in path_dict:
        ...
        for i in range(len(pathInd)):
            ...
            if i == len(pathInd)-1:
                ...
                if path_id == '1f' or path_id == '2r':
                    n_path_line = dl.Polyline(color="#d90ba9", weight=2, positions=n_path_positions)
                else:
                    n_path_line = dl.Polyline(color="#fcba03", weight=2, positions=n_path_positions)
